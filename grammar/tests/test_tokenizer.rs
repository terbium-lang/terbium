...
fn test_tokenizer_strings() {
    assert_tokens! {
        r####"
            ...
            #"raw multi-line "quotes inside" string"#
            ###"multiple #"hashes"#"###
            $"interpolated string"
        ...
        "####,
        TokenInfo::StringLiteral("single-quoted string".into(), StringLiteralFlags(0)) => 13..35,
        TokenInfo::StringLiteral("double-quoted string".into(), StringLiteralFlags(0)) => 48..70,
        TokenInfo::StringLiteral("'nested' string".into(), StringLiteralFlags(0)) => 83..100,
        TokenInfo::StringLiteral("\\\"escaped quotes\\\"".into(), StringLiteralFlags(0)) => 113..133,
        TokenInfo::StringLiteral("escaped backslash \\\\".into(), StringLiteralFlags(0)) => 146..168,
        TokenInfo::StringLiteral("multi-line string".into(), StringLiteralFlags(0)) => 181..202,
        TokenInfo::StringLiteral("raw string".into(), StringLiteralFlags(1)) => 215..228,
        TokenInfo::StringLiteral("raw \\ string".into(), StringLiteralFlags(1)) => 241..256,
        TokenInfo::StringLiteral("raw multi-line string".into(), StringLiteralFlags(1)) => 269..295,
        TokenInfo::StringLiteral("raw multi-line \"quotes inside\" string".into(), StringLiteralFlags(0)) => 308..349,
        TokenInfo::StringLiteral("multiple #\"hashes\"#".into(), StringLiteralFlags(0)) => 362..389,
        TokenInfo::StringLiteral("interpolated string".into(), StringLiteralFlags(2)) => 402..424,
        TokenInfo::StringLiteral("interpolated multi-line string".into(), StringLiteralFlags(2)) => 437..472,
        TokenInfo::StringLiteral("raw interpolated string".into(), StringLiteralFlags(3)) => 485..512,
        TokenInfo::StringLiteral("raw interpolated multi-line string".into(), StringLiteralFlags(3)) => 525..565,
    }
}
